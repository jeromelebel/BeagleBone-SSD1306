...
SSD1306::SSD1306(unsigned char address, SSD1306_Type type)
{
    ...
    _type = type;
    _i2cFileHandler = 0;
    _display = new Display(this->getWidth(), this->getHeight());
}
...
void SSD1306::pushDisplay(void)
{
    ...
    unsigned char *buffer = _display->getBuffer();
...
PixelCoordonate SSD1306::getWidth()
{
    PixelCoordonate width = 0;
...
PixelCoordonate SSD1306::getHeight()
{
    PixelCoordonate height = 0;
